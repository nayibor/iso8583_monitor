defmodule Iso8583MonitorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Iso8583MonitorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Iso8583MonitorWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  @doc ~S"""
  Renders a transaction table with generic styling.
